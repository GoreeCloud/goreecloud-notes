...
- Backend unit tests plus live Compose validation for authentication, workspace, organization, search, revisions, attachments, attachment-store integrity auditing, CLI/browser portability, native portable re-import, Memos migration/provenance, and destructive disposable database-plus-attachment recovery.
