...
transitional Memos storage. Authentication/session tables are intentionally kept
out of this module until the authentication design is reviewed separately.
"""
...
class User(TimestampMixin, Base):
    ...
    Credential/session material is deliberately not stored here yet. The future
    authentication implementation will reference this stable ownership identity.
    """
